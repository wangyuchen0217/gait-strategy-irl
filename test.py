...
q_value_ante = np.loadtxt('test_folder/maxent/Carausius/ante_gait/q_values_maxent_direction.csv', delimiter=',')
q_value_dirvel = np.loadtxt('test_folder/maxent/Carausius/dirvel_gait/q_values_maxent_direction.csv', delimiter=',')
q_value_accvel = np.loadtxt('test_folder/maxent/Carausius/accvel_gait/q_values_maxent_velocity.csv', delimiter=',')

trajectory_ante = np.loadtxt('test_folder/maxent/Carausius/ante_gait/trajectories.csv', delimiter=',')
trajectory_dirvel = np.loadtxt('test_folder/maxent/Carausius/dirvel_gait/trajectories.csv', delimiter=',')
trajectory_accvel = np.loadtxt('test_folder/maxent/Carausius/accvel_gait/trajectories.csv', delimiter=',')

state_indices_ante = trajectory_ante[:, 0].astype(int)
state_indices_dirvel = trajectory_dirvel[:, 0].astype(int)
state_indices_accvel = trajectory_accvel[:, 0].astype(int)
actions = trajectory_ante[:, 1].astype(int)
