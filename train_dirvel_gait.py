'''
This code is used to train the MaxEnt IRL algorithm on the velocity-direction dataset.
states: 2D (velocity, direction)
...
if mode == 'test':
    ...
    plot_replicated_action_prob(q_values, state_indices, test_folder, label="vel-dir")
