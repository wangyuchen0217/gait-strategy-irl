...
def plot_states(vel_01, vel_02, vel_03, direction_01, direction_02, direction_03, acc_01, acc_02, acc_03):
    # velocity
    ...
    axes[2].grid()
    plt.tight_layout()
    plt.savefig('expert_demonstration/expert/plot/CarausiusC00_acc.png')