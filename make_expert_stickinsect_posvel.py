...
forces_save_path = os.path.join("expert_data_builder/stick_insect", animal, "Animal12_110415_00_22_forces.csv")
pd.DataFrame(forces).to_csv(forces_save_path, header=None, index=["LF_sup", "LM_sup", "LH_sup", "RF_sup", "RM_sup", "RH_sup",
