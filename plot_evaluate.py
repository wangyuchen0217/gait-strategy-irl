...
#     plt.figure(figsize=(10, 8))
#     plt.title("Reward Function Heatmap (State-Action Rewards)")
#     plt.xlabel("Actions")
#     plt.ylabel("States")
...
#     plt.title("Reward Heatmap: Velocity vs. Action")
#     plt.xlabel("Actions")
#     plt.ylabel("Velocity Bins")
#     plt.colorbar(label='Reward Value')
#     plt.show()
...
def plot_acceleration_action_reward_heatmap(rewards, n_acceleration_bins, n_vel_bins):
    ...
    plt.figure(figsize=(10, 8))
    plt.imshow(reward_grid, cmap='viridis', aspect='auto')
    plt.title("Reward Heatmap: Acceleration vs. Action")
    plt.xlabel("Actions")
    plt.ylabel("Acceleration Bins")
    plt.colorbar(label='Reward Value')
    plt.show()