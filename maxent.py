...
def customirl(feature_matrix, n_actions, discount, transition_probability,
    ...
    for i in range(epochs):
        ...
        if (i + 1) % 10 == 0:
            ...
            # plot_grid_based_rewards(rewards, n_acceleration_bins=21, n_vel_bins=28, epoch=str(i+1))
...
def maxentirl(feature_matrix, n_actions, discount, transition_probability,
    ...
    for i in range(epochs):
        ...
        if (i + 1) % 10 == 0:
            ...
            # plot_grid_based_rewards(rewards, n_acceleration_bins=21, n_vel_bins=28, epoch=str(i+1), test_folder=test_folder)
