...
class StickInsectEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self, max_timesteps=500, r=None):
        ...
        self.prev_obs = None
        # Import xml document
        self.model = mujoco_py.load_model_from_path("/home/yuchen/insect_walking_irl/envs/assets/StickInsect-v0.xml")
        mujoco_env.MujocoEnv.__init__(self, '/home/yuchen/insect_walking_irl/envs/assets/StickInsect-v0.xml', 2)
