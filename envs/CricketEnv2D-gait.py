...
class CricketEnv2D(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self, max_timesteps=500, T=None,  r=None):
        ...
        self.r = r
        self.prev_obs = None
        self.model = mujoco_py.load_model_from_path("/home/yuchen/Crickets_Walking_IRL/envs/assets/Cricket2D-gait.xml")
        mujoco_env.MujocoEnv.__init__(self, '/home/yuchen/Crickets_Walking_IRL/envs/assets/Cricket2D-gait.xml', 2)
