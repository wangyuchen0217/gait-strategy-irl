...
def get_antenna_dist(subject:str, bin_step=60):
    ...
    antenna_visualization(antenna_01, smoothed_antenna_01, 'smoothed_dp3', subject=subject, save=True)
    antenna_visualization(antenna_01, t_elps_antenna_01, 'time_elapsed_dp3', subject=subject, save=True)
    antenna_visualization(antenna_01, discrete_data, 'discretized_dp3', subject=subject, save=True)
    plot_time_elapsed_histogram_subplots(discrete_data, bin_step, 'dp3', subject=subject, save=True)
